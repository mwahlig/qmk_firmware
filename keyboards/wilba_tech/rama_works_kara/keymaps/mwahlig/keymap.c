...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT_60_hhkb(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FN),
				KC_LALT, KC_LGUI,                            NAVSPC,                             KC_RGUI, _______),
	...
	[_GAME] = LAYOUT_60_hhkb(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FN),
				KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, _______),
	...
	[_HYPER] = LAYOUT_60_hhkb(
		...
		_______, HYPR(KC_F17), HYPR(KC_F18), HYPR(KC_F19), HYPR(KC_F20), HYPR(KC_F21), HYPR(KC_F22), HYPR(KC_F23), HYPR(KC_F24), _______, _______, _______, _______,
				QK_RBT, QK_BOOT,                            KC_SPC,                            _______, _______),
	...
	[_CODE] = LAYOUT_60_hhkb(
		...
		_______, QWERTY, GAME, _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______,  _______,  _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _HYPER, _FN, _CODE);
}
