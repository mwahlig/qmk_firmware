...
[_BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,    KC_TRNS,              KC_TRNS,      KC_N,  KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_ENT),
  MO(FN),   KC_LCTL,  KC_LALT,  KC_LGUI,  LOWER,                                                       RAISE,  KC_RGUI,  KC_RALT,  KC_RCTL,  KC_TRNS,
                                                    KC_TRNS, KC_TRNS,              KC_HOME, KC_END,
                                                             KC_TRNS,              KC_PGUP,
                                            KC_SPC, KC_TRNS, KC_TRNS,              KC_PGDN, KC_TRNS, KC_SPC
),
/* Keymap 1: Game layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[_LOWER] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_TRNS,     KC_TRNS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_F12,
  KC_TRNS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,               KC_DOWN, KC_4,    KC_UNDS, KC_PLUS, KC_LCBR, KC_TRNS,
