 ...
 */
 ...
 [_HHKB] = LAYOUT_ortho_hhkb(
  ...
  KC_CESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______, _______, KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______, _______, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT), \
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x14(
  ...
  KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_PGDN, _______, _______, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, \
